...
class TweetApiTests(TestCase):
    ...
    def setUp(self):
        self.clear_cache()
        self.user1 = self.create_user('user1', 'user1@twtr.com')
        self.tweets1 = [
        ...
        self.user2 = self.create_user('user2', 'user2@twtr.com')
        self.tweets2 = [
    ...
    def test_list_api(self):
        ...
        # check whether the tweets are ordered by 'created_at' in descending order, latest tweet first
    ...
    def test_create_with_files(self):
        ...
        # upload single file
        # content has to be type of bytes, so we need str.encode to transform
